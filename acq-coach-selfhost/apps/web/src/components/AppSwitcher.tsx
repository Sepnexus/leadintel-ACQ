...
const OTHER_APP_KEY  = (import.meta.env.VITE_OTHER_APP_KEY  as string | undefined) ?? "leadintel";
const LAUNCHER_URL =   import.meta.env.VITE_LAUNCHER_URL   as string | undefined;
const THIS_APP_KEY  =  (import.meta.env.VITE_THIS_APP_KEY  as string | undefined) ?? "acq";
