...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (merged["ACQ_STRIPE_TEST_WEBHOOK_SECRET"]) merged["STRIPE_TEST_WEBHOOK_SECRET"] = merged["ACQ_STRIPE_TEST_WEBHOOK_SECRET"];
    if (merged["ACQ_STRIPE_LIVE_WEBHOOK_SECRET"]) merged["STRIPE_LIVE_WEBHOOK_SECRET"] = merged["ACQ_STRIPE_LIVE_WEBHOOK_SECRET"];
