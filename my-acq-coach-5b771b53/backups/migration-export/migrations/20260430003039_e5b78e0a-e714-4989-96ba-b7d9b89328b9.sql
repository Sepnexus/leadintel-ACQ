...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO public.usage_events (
      ...
      effective_seconds, markup_multiplier, call_id, ghl_message_id, metadata
    ) VALUES (
      ...
      _call.dur, 2.0, _call_id, _call.id || '-msg', '{"demo":true}'::jsonb
    ),
    (
      _account_id, 'openai', 'score', 'gpt-5-mini', 'success',
      0, 1200, 800, 0.5, 1, NULL, 2.0, _call_id, _call.id || '-msg', '{"demo":true}'::jsonb
    );
  END LOOP;
