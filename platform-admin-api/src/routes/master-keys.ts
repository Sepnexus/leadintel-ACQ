...
const ALLOWED: Array<{ name: string; description: string; sensitive?: boolean }> = [
  ...
  { name: "STRIPE_TEST_WEBHOOK_SECRET", description: "Stripe test webhook signing secret",  sensitive: true },
  ...
  { name: "STRIPE_LIVE_WEBHOOK_SECRET", description: "Stripe live webhook signing secret",  sensitive: true },
  { name: "ACQ_STRIPE_TEST_WEBHOOK_SECRET",       description: "Stripe TEST webhook signing secret for the ACQ endpoint",  sensitive: true },
  { name: "ACQ_STRIPE_LIVE_WEBHOOK_SECRET",       description: "Stripe LIVE webhook signing secret for the ACQ endpoint",  sensitive: true },
  { name: "LEADINTEL_STRIPE_TEST_WEBHOOK_SECRET", description: "Stripe TEST webhook signing secret for the LI endpoint",   sensitive: true },
  { name: "LEADINTEL_STRIPE_LIVE_WEBHOOK_SECRET", description: "Stripe LIVE webhook signing secret for the LI endpoint",   sensitive: true },
